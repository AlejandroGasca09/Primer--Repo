...
public class VentanaGeneroMusical extends JFrame {
    ...
    public JLabel getLblEpoca() {
        return lblEpoca;
    }

    public void setLblEpoca(JLabel lblEpoca) {
    ...
    public JTextField getTxtEpoca() {
        return txtEpoca;
    }

    public void setTxtEpoca(JTextField txtEpoca) {
